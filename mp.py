...
def usage():
    ...
    print('Results are stored in one of four .csv files, depending on the value of the first parameter; i.e.\n')
    ...
    print('  For information about a specific mountainproject.com member, use the following convention:\n')
    ...
    print('        member@domain.com is the email address to which the desired mountainproject member is registered,')
    print('    and member-key is the mountainproject-assigned private key associated with the member\'s email address (see API docs).\n')
    print('  EXAMPLE:\n')
    ...
    print('    and member-key is a valid mountainproject-assigned private key (see API docs).\n')
    print('  EXAMPLE:\n')
